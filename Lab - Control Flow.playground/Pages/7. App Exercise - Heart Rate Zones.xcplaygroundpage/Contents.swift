...
case 121...140:
    print("You are in the Light zone. Activity in this zone improves basic endurance and fat burning.")
case 121...160:
    print("You are in the Moderate zone. Activity in this zone helps to improve aerobic fitness.")
case 161...180:
